...
## Purpose
Public privacy-first UTM generator (`utm.airat.top`).
...
## AI Working Notes
- Preserve local-first behavior and URL-building compatibility.
- Keep preset names and output behavior stable for returning users.
